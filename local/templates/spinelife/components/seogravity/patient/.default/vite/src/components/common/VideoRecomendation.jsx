...
Modal.setAppElement('#react-lk-patient');  //@TODO заменить на точку входа битрикс компонента
  ...
  <>
      <div className="video_item">
          <div className="video_item_img">
              ...
              <button className="video_item_play" onClick={() => setModalIsOpen(true)}></button>
          </div>
      ...
      >
          <button className="video-modal-close" onClick={() => setModalIsOpen(false)}>X</button>
          <iframe
              width="100%"
              height="500"
              src={getEmbedUrl(url)}
