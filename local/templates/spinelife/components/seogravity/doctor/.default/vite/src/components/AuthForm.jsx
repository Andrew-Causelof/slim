            ...
            <form className="auth_form form" onSubmit={handleSubmitAuth}>
              ...
              <div className="auth_form_controls">
                <div className="control">
                  <label className="control_title" htmlFor="mail">
                    Электронная почта
                  </label>
                  <input
                ...
                <div className="control">
                  <label className="control_title" htmlFor="password">
                    Пароль
                  </label>
                  <input
                ...
                <div className="auth_form_control">
                  <button
                    className="form_btn btn btn-main btn-fw"
                    type="submit"
                  >
                    Войти
                  </button>
                ...
                <div className="auth_form_control auth_form_control-reset">
                  <p>
                    Забыли пароль?{' '}
                    <a onClick={() => setRestore(true)}>Восстановить</a>
                  </p>
                </div>
              </div>
              <div className="auth_form_footer">
                <a href="#">SL-Клиника</a>
                <p>
                  Клиника консервативного лечения заболеваний позвоночника и
                  суставов
                </p>
              </div>
            </form>
        ...
        <section className="auth gradient auth-restore">
          <div className="container">
            <form className="auth_form form" onSubmit={handleSubmitRestore}>
              ...
              <div className="auth_form_controls">
                <div className="control">
                  <label className="control_title" htmlFor="mail_resore">
                    Электронная почта
                  </label>
                  <input
                    className={error && !email ? 'err' : 'ok'}
                ...
                <div className="auth_form_control auth_form_control-reset">
                  <p>
                    <a onClick={() => setRestore(false)}>Вход в аккаунт</a>
                  </p>
                </div>
              </div>
              <div className="auth_form_footer">
